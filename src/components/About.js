...
export default function About() {
        const [myStyle, setmyStyle] = useState   //for button use my to use State and import
     ({
        color: "green",
    ...
    return (
        <div className='container' style={myStyle}>
            <h1 className='my-3'>Abouth us</h1>
            ...
            <div className="my-2">
                <button onClick={toggleStyle} type='button' className='btn btn-primary'>Enablemode</button>
            </div>
        </div>
    )
}
